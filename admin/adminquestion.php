...
if (isset($_GET['delete'])) {
    $sno = $_GET['delete'];
    $delete = true;
    $sql2 = "DELETE FROM `threads` WHERE thread_id = '$sno'";
    $sql3 = "DELETE FROM `comments` WHERE thread_id = '$sno'";
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="adminquestion.php">
                                            ...
                                            echo '<div class="col-md-3 my-2">
                                                    <div class="card" style="width: 15rem; height:auto;">
                                                          <div class="card-body">
                                                            ...
                                                            <a href="adminquestionlist.php?threadid=' . $id . '" class="btn btn-primary mt-4">View Response</a>
                                                            <a href="adminquestion.php?delete=' . $id . '"id="d' . $id . '" class="delete mt-4 btn btn-sm btn-danger">Delete</a>
                                                          </div>
                                                    </div>
                                                  </div>';
                                        }
